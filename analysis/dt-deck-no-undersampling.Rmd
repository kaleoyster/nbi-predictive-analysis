...
filename<-paste('../../data/model/deck/tree-deck-no-undersample', toString(tl), '.csv', collapse = '')
...
write.csv(probabilities_dt, '../../data/metrics/dt/tree-prob-deck-nou.csv')
write.csv(df_metric_dt, '../../data/metrics/dt/tree-metric-deck-nou.csv')

df_metric_dt
probabilities_dt

# variable importance -> random forest (for all tunelength) -> Ranking (for all variables) 
# Understanding the relevance of the parameters 
```
