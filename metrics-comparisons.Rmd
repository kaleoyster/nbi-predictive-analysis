...
##### *Reading csv files*
```{r}
dt_mets = read.csv('Documents/github/nbi-predictive-analysis/tree-metric-deck-nou.csv') 
rf_mets = read.csv('Documents/github/nbi-predictive-analysis/rf-metrics-nou.csv')
```
